...
import {Box, Flex, VStack, HStack, Text, Spacer, Container, Image, useColorModeValue, Heading, Button, Select, Fade, border} from '@chakra-ui/react'
...
function ProdDetails() {
  ...
  let imgSrcs = ['https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/a0a300da-2e16-4483-ba64-9815cf0598ac/air-force-1-07-mens-shoes-5QFp5Z.png', 'https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/b7d9211c-26e7-431a-ac24-b0540fb3c00f/air-force-1-07-mens-shoes-5QFp5Z.png', 'https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5,q_80/33533fe2-1157-4001-896e-1803b30659c8/air-force-1-07-mens-shoes-5QFp5Z.png', 'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,b_rgb:f5f5f5/120a31b0-efa7-41c7-9a84-87b1e56ab9c3/air-force-1-07-mens-shoes-5QFp5Z.png' ]
   ...
   let changeMainImage = (e)=>{
    const allImgs = e.target.parentElement.childNodes
    allImgs.forEach((img)=>{
    ...
    <Box bg={useColorModeValue('gray.100', 'gray.700')}>
      <Flex direction={{base: 'column', md: 'row'}}>
        ...
        <VStack w={{base:'100%', sm:'100%', md:'60%'}} overflow='hidden' p={5}>
          <Image src={mainImg} w={{ base: '280px', sm: '280px', lg: '500px' }} h={{ base: '280px', sm: '280px', lg: '500px' }} outline='solid 2px black'/>
          <HStack p={5}>
            <Image w={{ base: '70px', sm: '70px', lg: '125px' }} h={{ base: '70px', sm: '70px', lg: '125px' }} src={imgSrcs[0]} border='solid 2px black' onMouseEnter={changeMainImage}/>
            <Image w={{ base: '70px', sm: '70px', lg: '125px' }} h={{ base: '70px', sm: '70px', lg: '125px' }} src={imgSrcs[1]} onMouseEnter={changeMainImage}/>
            <Image w={{ base: '70px', sm: '70px', lg: '125px' }} h={{ base: '70px', sm: '70px', lg: '125px' }} src={imgSrcs[2]} onMouseEnter={changeMainImage}/>
            <Image w={{ base: '70px', sm: '70px', lg: '125px' }} h={{ base: '70px', sm: '70px', lg: '125px' }} src={imgSrcs[3]} onMouseEnter={changeMainImage}/>
          </HStack>
        </VStack>
